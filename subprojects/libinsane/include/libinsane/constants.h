#ifndef __LIBINSANE_CONSTANTS_H
#define __LIBINSANE_CONSTANTS_H


#define OPT_NAME_SOURCE "source" // Sane only
#define OPT_VALUE_SOURCE_FLATBED "flatbed"
#define OPT_VALUE_SOURCE_ADF "feeder"

#define OPT_NAME_FEEDER_ENABLED "feeder_enabled" // TWAIN only
